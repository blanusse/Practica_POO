...
public class CityPassTester {
    public static void main(String[] args) throws CannotVisitAttractionException {
...
// anterior a la fecha del pase (16/04/2022)
        CityPass unlimitedCP = new Pass1(attractions, "Olivia", LocalDate.of(2022, 4, 16));
...
// donde el pase tiene un límite de 2 atracciones
        CityPass limitedVisitsCP = new Pass2(attractions, "Peter", LocalDate.of(2022, 4, 16), 2);
...
// donde el pase vence el 19/04/2022
        CityPass endDateCP = new Pass3(attractions, "Walter", LocalDate.of(2022, 4, 16), LocalDate.of(2022, 4, 19));
