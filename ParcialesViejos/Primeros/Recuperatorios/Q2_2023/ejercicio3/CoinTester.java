...
// Se agrega la moneda de oro "One Dollar" de Australia acuñada en 2016 de 22 quilates
        ...
        coinInventory.addGoldCoin("Parliament", "Canada", 2023, 20).addSilverCoin("Phillip Island", "Australia", 2019);
...
// La moneda debe ser acuñada en un año par
        Predicate<Coin> mintedInOddYears = new Predicate<Coin>() {
            @Override
            public boolean test(Coin coin) {
                return coin.getYear() % 2 ==0;
            }
        };
...
// La moneda debe ser del país Australia
        Predicate<Coin> fromAustralia = new Predicate<Coin>() {
            @Override
            public boolean test(Coin coin) {
                return coin.getCountry().equals("Australia");
            }
        };
