...
// Se instancia un ferry Beaver de la compañía TransLink
        Ferry beaver = new Ferry("Beaver"
                , transLink);
        Ferry otter = new Ferry("Otter II"
                , transLink);
        Ferry pacificBreeze = new Ferry("Pacific Breeze"
                , transLink);
// Se instancia un puerto Waterfront de la compañía TransLink con 2 muelles
// donde se pueden amarrar ferrys las 24hs
Puerto waterfront = new Puerto("Waterfront", transLink, 2);
...
// Se desamarra un ferry de una compañía distinta a la del puerto
        waterfront.undock(new Ferry("Spirit of Vancouver", new FerryCompany("BC Ferries")), LocalTime.of(10, 20));
...
Puerto londsdaleQuay = new Puerto2("Lonsdale Quay" , new FerryCompany("Translink"), 3, LocalTime.of(9, 0), LocalTime.of(14, 0));
...
Puerto stanleyPark = new Puerto3("Stanley Park", transLink, 3, LocalTime.of(9, 0), LocalTime.of(14, 0));
