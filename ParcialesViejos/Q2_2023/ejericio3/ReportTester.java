...
// indicando en el constructor un orden alfabético
        ReportCollection<String> maxToMinWords = new MaxToMinReport<
                >(alphaCmp);
...
// un orden descendente por temperatura y desempata alfabético por ciudad
        ...
        maxToMinSts.add(new FeelsLikeWeather("Juneau", 15, 13));
        maxToMinSts.add(new FeelsLikeWeather("Atlanta", 15, 16));
...
// [Feels like 16 degrees, Feels like 13 degrees, Feels like 20 degrees]
    ...
    static class Weather {
        ...
        public String toString() {
            return "It's %d degrees in %s"
                    .formatted(temperature, city);
        }
    }
