package ParcialesViejos.Q1_2023.ejercicio1;
...
// pasando sólo por las posiciones pares
        CustomIndex<String> cIdx2 = new CustomIndex<
                >(v1, 0, 3, idx -> idx + 2);
...
// Si start no es menor que end se arroja un error
            CustomIndex<Double> cIdx3 = new CustomIndex<
                    >(v2, 2, 0, idx -> idx - 1);
        } catch (Exception ex) {
...
// Con la siguiente función para conseguir el próximo índice el iterador no avanza
        CustomIndex<Double> cIdx4 = new CustomIndex<
                >(v2, 0, 2, idx -> idx);
