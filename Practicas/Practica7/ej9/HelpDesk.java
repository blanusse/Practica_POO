package Practicas.Practica7.ej9;

import java.util.*;

public class HelpDesk {
    private final Map<ClientType, Queue<HelpTicket>> desk = new EnumMap<>(ClientType.class);
    ...
    public static class HelpTicket implements Comparable<HelpTicket>{
        ...
        @Override
        public int compareTo(HelpTicket o) {
